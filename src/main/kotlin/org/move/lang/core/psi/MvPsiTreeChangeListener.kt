...
sealed class MvPsiTreeChangeEvent {
    /**
...
abstract class MvPsiTreeChangeAdapter : PsiTreeChangeListener {

    abstract fun handleEvent(event: MvPsiTreeChangeEvent)

    override fun beforePropertyChange(event: PsiTreeChangeEvent) {
        handleEvent(
            MvPsiTreeChangeEvent.PropertyChange.Before(
                event.propertyName,
                event.oldValue,
                event.newValue,
                event.element,
    ...
    override fun propertyChanged(event: PsiTreeChangeEvent) {
        handleEvent(
            MvPsiTreeChangeEvent.PropertyChange.After(
                event.propertyName,
                event.oldValue,
                event.newValue,
                event.element,
    ...
    override fun beforeChildReplacement(event: PsiTreeChangeEvent) {
        handleEvent(
            MvPsiTreeChangeEvent.ChildReplacement.Before(
                event.file,
                event.parent,
                event.oldChild,
                event.newChild
    ...
    override fun childReplaced(event: PsiTreeChangeEvent) {
        handleEvent(
            MvPsiTreeChangeEvent.ChildReplacement.After(
                event.file,
                event.parent,
                event.oldChild,
                event.newChild
    ...
    override fun beforeChildAddition(event: PsiTreeChangeEvent) {
        handleEvent(
            MvPsiTreeChangeEvent.ChildAddition.Before(
                event.file,
                event.parent,
                event.child
            )
    ...
    override fun childAdded(event: PsiTreeChangeEvent) {
        handleEvent(
            MvPsiTreeChangeEvent.ChildAddition.After(
                event.file,
                event.parent,
                event.child
            )
    ...
    override fun beforeChildMovement(event: PsiTreeChangeEvent) {
        handleEvent(
            MvPsiTreeChangeEvent.ChildMovement.Before(
                event.file,
                event.oldParent,
                event.newParent,
                event.child
    ...
    override fun childMoved(event: PsiTreeChangeEvent) {
        handleEvent(
            MvPsiTreeChangeEvent.ChildMovement.After(
                event.file,
                event.oldParent,
                event.newParent,
                event.child
    ...
    override fun beforeChildRemoval(event: PsiTreeChangeEvent) {
        handleEvent(
            MvPsiTreeChangeEvent.ChildRemoval.Before(
                event.file,
                event.parent,
                event.child
            )
    ...
    override fun childRemoved(event: PsiTreeChangeEvent) {
        handleEvent(
            MvPsiTreeChangeEvent.ChildRemoval.After(
                event.file,
                event.parent,
                event.child
            )
    ...
    override fun beforeChildrenChange(event: PsiTreeChangeEvent) {
        handleEvent(
            MvPsiTreeChangeEvent.ChildrenChange.Before(
                event.file,
                event.parent,
    ...
    override fun childrenChanged(event: PsiTreeChangeEvent) {
        handleEvent(
            MvPsiTreeChangeEvent.ChildrenChange.After(
                event.file,
                event.parent,
                (event as? PsiTreeChangeEventImpl)?.isGenericChange == true
            )
