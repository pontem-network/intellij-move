...
class NoEndlessProjectDetectedNotification(project: Project): MvEndlessEditorNotificationProvider(project),
                                                            DumbAware {
    ...
    override fun createEndlessNotificationPanel(
        file: VirtualFile,
        project: Project
        ...
        if (moveProjectsService.allProjects.isEmpty()) {
            ...
            return EditorNotificationPanel().apply {
                text = "No Endless projects found"
        ...
        if (moveProjectsService.findMoveProjectForFile(file) == null) {
            return EditorNotificationPanel().apply {
                text = "File does not belong to any known Endless project"
                createActionLabel("Do not show again") {
                    disableNotification(file)
                    updateAllNotifications(project)
                }
