...
data class HumanEndlessCompilerError(
    val message: String,
    ...
    fun toJsonError(file: PsiFile, document: Document): JsonEndlessCompilerError? {
        ...
        val jsonCompilerError = JsonEndlessCompilerError(
    ...
    companion object {
        ...
        fun forTest(
            ...
            return HumanEndlessCompilerError(message, severityLevel, span)
        }
    }
}
...
fun parseHumanCompilerErrors(outputLines: List<String>): List<HumanEndlessCompilerError> {
...
private fun rawMessageToCompilerMessage(rawMessage: RawMessage): HumanEndlessCompilerError? {
    ...
    return HumanEndlessCompilerError(message, rawMessage.errorType.severityLevel, primarySpan)
}
