...
import org.move.cli.runConfigurations.test.EndlessTestConsoleProperties.Companion.TEST_FRAMEWORK_NAME

class EndlessTestConsoleBuilder(
    private val config: EndlessCommandConfiguration,
