...
import org.move.cli.runConfigurations.test.EndlessTestConsoleProperties

class EndlessCommandConfiguration(
    project: Project,
    ...
    override fun getConfigurationEditor() = EndlessCommandConfigurationEditor()
    ...
    override fun createTestConsoleProperties(executor: Executor): TestConsoleProperties? {
        ...
        return if (showTestToolWindow(config.cmd)) {
            EndlessTestConsoleProperties(this, executor)
        } else {
            null
        }
    }
