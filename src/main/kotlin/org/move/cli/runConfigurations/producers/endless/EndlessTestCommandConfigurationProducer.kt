package org.move.cli.runConfigurations.producers.endless
...
import org.move.cli.runConfigurations.endless.EndlessCommandConfigurationType
import org.move.cli.runConfigurations.endless.cmd.EndlessCommandConfigurationFactory
import org.move.cli.runConfigurations.producers.EndlessCommandLineFromContext
...
class EndlessTestCommandConfigurationProducer: CommandConfigurationProducerBase() {

    override fun getConfigurationFactory() =
        EndlessCommandConfigurationFactory(EndlessCommandConfigurationType.getInstance())

    override fun fromLocation(location: PsiElement, climbUp: Boolean): EndlessCommandLineFromContext? {
        return when {
    ...
    private fun findTestFunction(psi: PsiElement, climbUp: Boolean): EndlessCommandLineFromContext? {
        ...
        return EndlessCommandLineFromContext(
            fn,
            confName,
            EndlessCommandLine(
                "move test",
    ...
    private fun findTestModule(psi: PsiElement, climbUp: Boolean): EndlessCommandLineFromContext? {
...
//        }
    ...
    private fun testArgsFromProjectSettings(project: Project): EndlessArgs =
        EndlessArgs().apply { applyExtra(project.moveSettings.testsExtraArgs) }
//        buildList {
